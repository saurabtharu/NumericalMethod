...
float poisonFunc(float x,float y){
	// return x * y;
	return 2 * x * x * y * y;
...
int main () {
	...
	printf("Enter the boundary value in left, right, bottom and upper part of the plate: ");
